...
У нас есть Github, куда мы выкладываем проекты https://github.com/vmkteam/ и [философия](/development/philosophy/), которую мы используем при разработке, а также [использование LLM](/development/llm-usage/).
